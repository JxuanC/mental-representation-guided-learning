...
from transformers import AutoTokenizer, CLIPFeatureExtractor, AutoModel, AutoModelForCausalLM,GPT2Tokenizer
...
from smallcap.src.xglm import ThisXGLMConfig, ThisXGLMForCausalLM
from smallcap.src.opt import ThisOPTConfig, ThisOPTForCausalLM

from smallcap.src.utils import *
...
def get_data(tokenizer, max_length, args):
    ...
    train_dataset = TrainDataset(
                        df=train_df,
                        features_path=os.path.join(args.features_dir, args.features_name + '.hdf5'),
                        tokenizer=tokenizer,
...
def main(args):
    ...
    output_dir = '{}_{}M_{}'.format(model_type, args.attention_size, args.features_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--features_dir", type=str, default="pretrained_features/", help="Directory where cached input image features are stored")
    parser.add_argument("--features_name", type=str, default="clip_coco_train", help="Directory where cached input image features are stored")
    parser.add_argument("--annotations_path", type=str, default="./dataset/dataset_coco.json", help="JSON file with annotations in Karpathy splits")
    parser.add_argument("--experiments_dir", type=str, default="./smallcap/experiments/", help="Directory where trained models will be saved")
